...
namespace dsfw {
    ...
    public:
        ...
        void registerProcessor(const QString &taskName, const QString &processorId, ProcessorFactory factory);
        ...
        std::unique_ptr<ITaskProcessor> create(const QString &taskName, const QString &processorId) const;
        ...
        struct Registrar {
            Registrar(const QString &taskName, const QString &processorId) {
                TaskProcessorRegistry::instance().registerProcessor(taskName, processorId,
