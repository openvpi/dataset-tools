...
namespace dsfw {
    ...
    using ModelProgressCallback = std::function<void(int64_t current, int64_t total, const QString &msg)>;
    ...
    public:
        ...
        virtual ~IModelProvider() noexcept = default;
        ...
        [[nodiscard]] virtual Result<void> load(const QString &modelPath, int gpuIndex) = 0;
