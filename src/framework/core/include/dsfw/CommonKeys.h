...
namespace dsfw::CommonKeys {
    ...
    inline const dstools::SettingsKey<int> ThemeMode("General/themeMode",
    ...
    inline const dstools::SettingsKey<QString> NavigationPrev("Shortcuts/prevFile",
                                                              "PgUp"); ///< Navigate to previous file shortcut.
    inline const dstools::SettingsKey<QString> NavigationNext("Shortcuts/nextFile",
                                                              "PgDown"); ///< Navigate to next file shortcut.

    inline const dstools::SettingsKey<QString> WindowGeometry("General/windowGeometry",
    ...
    inline const dstools::SettingsKey<QString> Language("General/language",
                                                        ""); ///< UI language ("" = system, "zh_CN", "en").

    inline const dstools::SettingsKey<QString> AudioSplitter("General/splitter/audio",
                                                             ""); ///< AudioVisualizerContainer splitter state.
    inline const dstools::SettingsKey<QString> PitchSplitter("General/splitter/pitch",
                                                             ""); ///< PitchLabelerPage splitter state.
    inline const dstools::SettingsKey<QString> MinSplitter("General/splitter/minlabel",
