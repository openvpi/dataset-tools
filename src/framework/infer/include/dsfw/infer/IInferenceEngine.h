...
namespace dsfw::infer {
    ...
    public:
        ...
        virtual ~IInferenceEngine() noexcept = default;
        ...
        [[nodiscard]] virtual Result<void> load(const std::filesystem::path &modelPath, ExecutionProvider provider, int deviceId) = 0;
        ...
        virtual int64_t estimatedMemoryBytes() const {
            return 0;
        }
    };
