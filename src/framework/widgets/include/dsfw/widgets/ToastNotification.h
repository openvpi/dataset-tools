...
namespace dsfw::widgets {
    ...
    public:
        ...
        static void show(QWidget *parent, ToastType type, const QString &message, int timeoutMs = 3000);
    ...
    private:
        explicit ToastNotification(QWidget *parent, ToastType type, const QString &message, int timeoutMs);
        void startDismiss();
        void reposition();
