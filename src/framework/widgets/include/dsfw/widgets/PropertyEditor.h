...
namespace dsfw::widgets {
    ...
    public:
        ...
        void addStringProperty(const QString &key, const QString &label, const QString &defaultValue = {});
        ...
        void addIntProperty(const QString &key, const QString &label, int defaultValue = 0, int min = INT_MIN,
                            int max = INT_MAX);
        ...
        void addDoubleProperty(const QString &key, const QString &label, double defaultValue = 0.0, double min = -1e9,
                               double max = 1e9, int decimals = 2);
        ...
        void addChoiceProperty(const QString &key, const QString &label, const QStringList &choices,
                               int defaultIndex = 0);
