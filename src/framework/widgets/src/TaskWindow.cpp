...
void TaskWindow::addFiles() {
    ...
    QStringList files = dsfw::FileDialogHelper::getOpenFileNames({this, tr("Add Files"), {}, {audioFileFilter()}});
...
void TaskWindow::addFolder() {
    if (m_isRunning) return;
    QString dir = dsfw::FileDialogHelper::getExistingDirectory({this, tr("Add Folder")});
