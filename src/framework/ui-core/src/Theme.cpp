...
namespace dsfw {
    ...
    static Theme::Palette makeDarkPalette() {
        ...
        p.audioVisualizer.spectrogramColor = QColor("#FF9933");
        ...
        p.phonemeEditor.slicerLabelText = QColor(200, 200, 220);
        p.phonemeEditor.slicerBorderLine = QColor(80, 80, 100);
    ...
    static Theme::Palette makeLightPalette() {
        ...
        p.audioVisualizer.waveformColor = QColor("#2B7FC0");
        p.audioVisualizer.powerColor = QColor("#C08820");
        p.audioVisualizer.spectrogramColor = QColor("#CC6611");
        ...
        p.phonemeEditor.slicerLabelText = QColor(80, 80, 100);
        p.phonemeEditor.slicerBorderLine = QColor(180, 180, 190);
