...
namespace dstools::labeler {
    ...
    public:
        ...
        virtual QMenuBar *createMenuBar(QWidget *parent) {
            Q_UNUSED(parent);
            return nullptr;
        }
        ...
        virtual QWidget *createStatusBarContent(QWidget *parent) {
            Q_UNUSED(parent);
            return nullptr;
        }
        ...
        virtual bool supportsDragDrop() const {
            return false;
        }
        /// @brief Handle a drag-enter event forwarded from the shell.
        /// @param event The drag-enter event.
        virtual void handleDragEnter(QDragEnterEvent *event) {
            Q_UNUSED(event);
        }
        /// @brief Handle a drop event forwarded from the shell.
        /// @param event The drop event.
        virtual void handleDrop(QDropEvent *event) {
            Q_UNUSED(event);
        }
    };
