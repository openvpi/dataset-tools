...
namespace dsfw {
    ...
    public:
        ...
        struct Palette {
            ...
            struct {
                QColor waveformColor;    ///< Waveform trace color.
                QColor powerColor;       ///< Power chart color.
                QColor spectrogramColor; ///< Spectrogram default base color.
            } audioVisualizer;
            ...
            struct {
                ...
                QColor slicerLabelText;        ///< Slicer auto-numbered label text.
                QColor slicerBorderLine;       ///< Slicer label area top/bottom border.
            } phonemeEditor;
        };
