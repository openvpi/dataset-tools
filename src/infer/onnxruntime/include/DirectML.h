...
#        if !defined(NTDDI_VERSION) ||                                                                                 \
            defined(DML_TARGET_VERSION_USE_LATEST) // Use the latest if using redist or no Windows target set.
...
STDAPI DMLCreateDevice1(ID3D12Device *d3d12Device, DML_CREATE_DEVICE_FLAGS flags, DML_FEATURE_LEVEL minimumFeatureLevel,
                        REFIID riid, // Expected: IDMLDevice
                        _COM_Outptr_opt_ void **ppv);
...
interface DML_DECLARE_INTERFACE("c8263aac-9e0c-4a2d-9b8e-007521a3317c") IDMLObject : IUnknown {
    IFACEMETHOD(GetPrivateData)(REFGUID guid, _Inout_ UINT * dataSize, _Out_writes_bytes_opt_(*dataSize) void *data) =
        0;
...
interface DML_DECLARE_INTERFACE("6dbd6437-96fd-423f-a98c-ae5e7c2a573f") IDMLDevice : IDMLObject {
    IFACEMETHOD(CheckFeatureSupport)(DML_FEATURE feature, UINT featureQueryDataSize,
    ...
    IFACEMETHOD(CreateOperatorInitializer)(UINT operatorCount,
    ...
    IFACEMETHOD(CreateCommandRecorder)(REFIID riid, // expected: IDMLCommandRecorder
                                       _COM_Outptr_ void **ppv) = 0;
...
interface DML_DECLARE_INTERFACE("29c687dc-de74-4e3b-ab00-1168f2fc3cfc") IDMLBindingTable : IDMLDeviceChild {
    IFACEMETHOD_(void, BindInputs)(UINT bindingCount, _In_reads_opt_(bindingCount) const DML_BINDING_DESC *bindings) =
        0;

    IFACEMETHOD_(void, BindOutputs)(UINT bindingCount, _In_reads_opt_(bindingCount) const DML_BINDING_DESC *bindings) =
        0;
...
interface DML_DECLARE_INTERFACE("e6857a76-2e3e-4fdd-bff4-5d2ba10fb453") IDMLCommandRecorder : IDMLDeviceChild {
    IFACEMETHOD_(void, RecordDispatch)(ID3D12CommandList * commandList, IDMLDispatchable * dispatchable,
...
interface DML_DECLARE_INTERFACE("a0884f9a-d2be-4355-aa5d-5901281ad1d2") IDMLDevice1 : IDMLDevice {
    IFACEMETHOD(CompileGraph)(const DML_GRAPH_DESC *desc, DML_EXECUTION_FLAGS flags,
                              REFIID riid, // expected: IDMLCompiledOperator
                              _COM_Outptr_opt_ void **ppv) = 0;
};
