...
private slots:
    ...
    void testExportSlicesEmptySamples() {
        ...
        auto result = dstools::SliceExportService::exportSlices(samples, 44100, points, opts);
    ...
    void testExportSlicesSingleSegment() {
        ...
        auto result = dstools::SliceExportService::exportSlices(samples, sr, points, opts);
