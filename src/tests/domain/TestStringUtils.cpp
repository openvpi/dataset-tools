...
void TestStringUtils::testFormatDur6_integer() {
    QCOMPARE(dsfw::formatDur6(1.0), QString("1"));
}

void TestStringUtils::testFormatDur6_decimal() {
    QCOMPARE(dsfw::formatDur6(0.123456), QString("0.123456"));
}

void TestStringUtils::testFormatDur6_trailingZeros() {
    QCOMPARE(dsfw::formatDur6(0.5), QString("0.5"));
    QCOMPARE(dsfw::formatDur6(0.25), QString("0.25"));
    QCOMPARE(dsfw::formatDur6(0.125), QString("0.125"));
}

void TestStringUtils::testFormatDur6_allZeros() {
    QCOMPARE(dsfw::formatDur6(2.0), QString("2"));
}

void TestStringUtils::testFormatDur6_zero() {
    QCOMPARE(dsfw::formatDur6(0.0), QString("0"));
}
