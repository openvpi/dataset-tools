...
namespace dstools {
    ...
    public:
        AddSlicePointCommand(std::vector<double> &points, double timeSec, std::function<void()> refresh);
        void undo() override;
        void redo() override;
    ...
    public:
        MoveSlicePointCommand(std::vector<double> &points, int index, double oldTime, double newTime,
    ...
    public:
        RemoveSlicePointCommand(std::vector<double> &points, int index, std::function<void()> refresh);
        void undo() override;
        void redo() override;
