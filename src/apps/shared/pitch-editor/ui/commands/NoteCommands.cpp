...
SetNoteGlideCommand::SetNoteGlideCommand(std::shared_ptr<DsPitchDocument> dsFile, int idx,
...
ToggleNoteSlurCommand::ToggleNoteSlurCommand(std::shared_ptr<DsPitchDocument> dsFile, int idx,
...
ToggleNoteRestCommand::ToggleNoteRestCommand(std::shared_ptr<DsPitchDocument> dsFile, int idx,
...
MergeNoteLeftCommand::MergeNoteLeftCommand(std::shared_ptr<DsPitchDocument> dsFile, int idx,
                                           QUndoCommand *parent)
    : QUndoCommand(parent), m_dsFile(std::move(dsFile)), m_idx(idx) {
...
SnapToPitchCommand::SnapToPitchCommand(std::shared_ptr<DsPitchDocument> dsFile, std::vector<int> indices,
