...
PianoRollChartPanel::PianoRollChartPanel(dsfw::widgets::ViewportController* vc, QWidget* parent)
    ...
    connect(m_pianoRoll, &PianoRollView::noteSelected, this, &PianoRollChartPanel::noteSelected);
    connect(m_pianoRoll, &PianoRollView::toolModeChanged, this, &PianoRollChartPanel::toolModeChanged);
    connect(m_pianoRoll, &PianoRollView::fileEdited, this, &PianoRollChartPanel::fileEdited);
    connect(m_pianoRoll, &PianoRollView::positionClicked, this, &PianoRollChartPanel::positionClicked);
    connect(m_pianoRoll, &PianoRollView::rulerClicked, this, &PianoRollChartPanel::rulerClicked);
    connect(m_pianoRoll, &PianoRollView::noteGlideChanged, this, &PianoRollChartPanel::noteGlideChanged);
    connect(m_pianoRoll, &PianoRollView::noteSlurToggled, this, &PianoRollChartPanel::noteSlurToggled);
    connect(m_pianoRoll, &PianoRollView::noteRestToggled, this, &PianoRollChartPanel::noteRestToggled);
    connect(m_pianoRoll, &PianoRollView::noteMergeLeft, this, &PianoRollChartPanel::noteMergeLeft);
    connect(m_pianoRoll, &PianoRollView::noteDeleteRequested, this, &PianoRollChartPanel::noteDeleteRequested);
    connect(m_pianoRoll, &PianoRollView::verticalScrolled, this, &PianoRollChartPanel::verticalContentScrolled);
