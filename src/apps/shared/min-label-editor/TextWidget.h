...
namespace Minlabel {
    /// @brief Widget with text input, language selection (Mandarin/Cantonese/Japanese), and Pinyin/Jyutping conversion
    /// with configurable tone and formatting options.
