...
namespace Minlabel {
    ...
    public:
        ...
        /// Set placeholder text shown when editors are empty (e.g. guidance for new users).
        void setPlaceholderText(const QString &contentPlaceholder, const QString &wordsPlaceholder);
        ...
        [[nodiscard]] TextWidget *textWidget() const {
            return m_textWidget;
        }
    ...
    private:
        ...
        dsfw::widgets::FileProgressTracker *m_fileProgress = nullptr;
