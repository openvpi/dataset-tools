...
QJsonObject AppSettingsBackend::load() const {
    ...
    pitchConfig["minF0"] = settings.value(QLatin1String(PitchMinF0), 50.0).toDouble();
    pitchConfig["maxF0"] = settings.value(QLatin1String(PitchMaxF0), 1100.0).toDouble();
...
void AppSettingsBackend::save(const QJsonObject &data) {
    ...
    settings.setValue(QLatin1String(PitchMinF0), pitchConfig["minF0"].toDouble(50.0));
    settings.setValue(QLatin1String(PitchMaxF0), pitchConfig["maxF0"].toDouble(1100.0));
