...
namespace dstools::AppSettingKeys {
    ...
    inline constexpr const char *PitchMinF0 = "Settings/pitchMinF0";
    inline constexpr const char *PitchMaxF0 = "Settings/pitchMaxF0";
    ...
    inline constexpr const char *AudioDevice = "App/audioDevice";

    inline QString readAppSettingString(const char *key, const QString &defaultValue = {}) {
        return QSettings().value(QLatin1String(key), defaultValue).toString();
    }

    inline void writeAppSettingString(const char *key, const QString &value) {
        QSettings().setValue(QLatin1String(key), value);
    }

    inline QStringList readAppSettingStringList(const char *key, const QStringList &defaultValue = {}) {
        return QSettings().value(QLatin1String(key), defaultValue).toStringList();
    }

    inline void writeAppSettingStringList(const char *key, const QStringList &value) {
        QSettings().setValue(QLatin1String(key), value);
    }
