...
namespace dstools {
    namespace phonemelabeler {
        ...
        public:
            ...
            SetIntervalTextCommand(TextGridDocument *doc, int tierIndex, int intervalIndex, const QString &oldText,
        ...
        public:
            RemoveBoundaryCommand(TextGridDocument *doc, int tierIndex, int boundaryIndex,
