...
QStringList LevenshteinDistance::fill_step_out(const QList<StepPair> &pairs, const bool &del_tip, const bool &ins_tip,
                                               const bool &sub_tip) {
    QStringList output;
...
int LevenshteinDistance::calculate_edit_distance_dp(matrix dp, const QStringList &substring, const QStringList &target,
...
QPair<QList<StepPair>, QList<StepPair>> LevenshteinDistance::backtrack_corresponding(matrix dp, const QStringList &text,
