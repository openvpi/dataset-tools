...
namespace dstools {
    ...
    public:
        ...
        Result<std::vector<G2PResult>> convert(const std::string &text, const std::string &langCode) override;

        /// @brief Convert a single word to its phoneme representation.
        /// @param word Input word.
        /// @param langCode Language code (e.g. "zh").
        /// @return A G2PResult or an error.
        Result<G2PResult> convertWord(const std::string &word, const std::string &langCode) override;
