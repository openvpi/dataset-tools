...
### CH-04: scripts/cmake/ 含空子目录

`scripts/cmake/` 为空目录。实际 cmake 工具脚本在 `cmake/`。`scripts/vcpkg-manifest/` 含 `vcpkg.json`，非空。

- **位置**: `scripts/cmake/`
- **目标**: 删除 `scripts/cmake/` 空目录
- **工作量**: XS
- **阻塞**: 无
...
**代码质量:**
CQ-003, CQ-005, CQ-006a, CQ-008, CQ-009, CQ-010, CQ-011
