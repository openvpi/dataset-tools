...
> 从 DiffSinger Dataset Tools 提取的 C++17/Qt6 通用桌面应用框架
...
dsfw 是基于 C++17/Qt6 的通用桌面应用框架，为模块化桌面工具提供开箱即用的基础设施。核心理念："Page 即应用" — AppShell 负责窗口框架，Page 负责业务逻辑，同一 Page 可独立运行也可嵌入多页面壳。
