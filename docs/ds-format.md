...
此字段为可选字段，不含此字段的 .dsproj 文件仍然合法。各步骤的模型配置详见 [08-project-format.md](refactor-plan/08-project-format.md)。
...
.dsitem 的完整格式规范和示例见 [08-project-format.md](refactor-plan/08-project-format.md)。
