...
- **[Framework Architecture](../developer/architecture/overview.md)** — Deep dive into the six-layer architecture, interface-driven design, plugin system, and migration strategy.
