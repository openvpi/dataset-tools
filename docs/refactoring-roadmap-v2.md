...
| 28.1 Phoneme 界面删除 tierline 区域 | 2026-05-07 |
| 29.1 HFA 对齐结果修复——与 main 分支对齐 | 2026-05-07 |
| 30.1 修复无边框窗口标题截断 | 2026-05-07 |
| 31.1 音高页面无标注时也能播放音频 | 2026-05-07 |
| 32.1 导出页面 CSV 预览深浅色主题修复 | 2026-05-07 |
...
## 任务 38：Phoneme 贯穿线在标签区域外可拖动

**需求**：phoneme 在标签区域以外的贯穿线不能正常拖动，需要修复使其在标签区域外也能响应拖拽操作。

**文件**：
- `src/apps/shared/phoneme-editor/`
